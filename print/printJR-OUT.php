<?php 
  ...
  if ($_SESSION['id'] == ""){
      ...
      header("location: ../qr/qr_out2.php");
  }elseif ($_POST['qtyOut'] > $_POST['balance']){
      header("location: ../qr/qr_out2.php");
  }else{     
...
$sql = "SELECT * FROM tbl_report_details WHERE product_id = '$prodID' AND product_name = '$prodName' AND id = (SELECT MAX(id) FROM tbl_report_details)";
...
if ($prodID != "" ) {
    ...
    $balance2 = intval($balance) - intval($qtyOut);
...
<body>
    <div class="container">
        <div class="navigation">
            ...
            <input type="text" id="qrInput" value="<?php echo $prodID."_".$prodName ?>" hidden>
            ...
            <div class="details">
                <div class="manualForm">
                    ...
                    <button type="submit" class="print" id="printSr" name="printSr" onclick="saveAsImage()"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M128 0C92.7 0 64 28.7 64 64v96h64V64H354.7L384 93.3V160h64V93.3c0-17-6.7-33.3-18.7-45.3L400 18.7C388 6.7 371.7 0 354.7 0H128zM384 352v32 64H128V384 368 352H384zm64 32h32c17.7 0 32-14.3 32-32V256c0-35.3-28.7-64-64-64H64c-35.3 0-64 28.7-64 64v96c0 17.7 14.3 32 32 32H64v64c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V384zM432 248a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"/></svg></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
      function backBtn(){
        window.location.href='../qr/qr_out.php';
      }
    </script>
    <script>
        function saveAsImage() {
            html2canvas(document.getElementById('save_to_image')).then(function(canvas) {
                ...
                resizedContext.drawImage(canvas, 0, 0, 570, 420);
                ...
                // Create a file from the blob
                    ...
                    var filename =  `${qrInput}_out`;
                    
                    // Append the file to the FormData object
                    formData.append('image', file, `${qrInput}_out.png`);
